...
class AspectTest extends Unittest_TestCase {
	...
	{
		return array(
			array(100, 500, 100, 100, Aspect::UPSCALE, array('width' => 20, 'height' => 100, 'x' => 40, 'y' => 0)),
			array(500, 200, 100, 100, Aspect::UPSCALE, array('width' => 100, 'height' => 40, 'x' => 0, 'y' => 30)),
			array(300, 300, 100, 100, Aspect::UPSCALE, array('width' => 100, 'height' => 100, 'x' => 0, 'y' => 0)),
			array(600, 900, 800, 600, Aspect::CENTER, array('width' => 400, 'height' => 600, 'x' => 200, 'y'=> 0)),
			array(600, 900, 1000, 2000, Aspect::CENTER, array('width' => 600, 'height' => 900, 'x' => 200, 'y' => 550	)),
			array(600, 900, 1000, 2000, Aspect::SHRINK, array('width' => 600, 'height' => 900, 'x' => 0, 'y' => 0)),
			array(600, 900, 1000, 2000, Aspect::SHRINK_WIDTH, array('width' => 600, 'height' => 900, 'x' => 0, 'y' => 550)),
			array(600, 900, 1000, 2000, Aspect::SHRINK_HEIGHT, array('width' => 600, 'height' => 900, 'x' => 200, 'y' => 0)),
		);
	}
	 ...
	 */
	public function test_constrain($width, $height, $constrain_width, $constrain_height, $flags, $expected)
	{
		$aspect = new Aspect($width, $height);

		$aspect->constrain($constrain_width, $constrain_height, $flags);
