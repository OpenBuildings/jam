 ...
 */
class Jam_Query_Builder_DeleteTest extends Unittest_TestCase {
	...
	public function test_constructor()
	{
		...
		$this->assertEquals('DELETE FROM test_authors', $select->compile());
	}
	...
	public function test_where()
	{
		...
		$this->assertEquals('DELETE FROM test_posts WHERE test_posts.test_author_id = 10', $select->compile());	
	}
	...
	public function test_order_by()
	{
		...
		$this->assertEquals('DELETE FROM test_posts ORDER BY test_posts.test_author_id DESC', $select->compile());	
	}
}
