 ...
 */
class Jam_Query_Builder_UpdateTest extends Unittest_TestCase {
	...
	public function test_constructor()
	{
		...
		$this->assertEquals('UPDATE test_authors SET name = \'Test\'', $select->compile());
	}
	...
	public function test_where()
	{
		...
		$this->assertEquals('UPDATE test_posts SET name = \'Test\' WHERE test_posts.test_author_id = 10', $select->compile());	
	}
	...
	public function test_order_by()
	{
		...
		$this->assertEquals('UPDATE test_posts SET name = \'Test\' ORDER BY test_posts.test_author_id DESC', $select->compile());	
	}
}
