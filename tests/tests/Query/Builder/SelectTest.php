...
class Jam_Query_Builder_SelectTest extends Unittest_TestCase {
	...
	public function test_constructor()
	{
		...
		$this->assertEquals('SELECT test_authors.* FROM test_authors', $select->compile());
	}
	...
	public function test_from()
	{
		...
		$this->assertEquals('SELECT author_table.* FROM test_authors AS author_table', $select->compile());

		$this->assertEquals('SELECT author_table.* FROM test_authors AS author_table', $select->compile(), 'Should not double quote selects');
	}
	...
	public function test_select()
	{
		...
		$this->assertEquals('SELECT test_authors.id AS primary_key, test_authors.name AS name_key FROM test_authors', $select->compile());
	}
	...
	public function test_alias()
	{
		...
		$this->assertEquals('SELECT author_table.* FROM test_authors AS author_table WHERE author_table.name = \'Alex\'', $select->compile());
	}
	...
	public function test_join()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts JOIN test_authors ON (test_authors.id = test_posts.test_author_id)', $select->compile());	
	}
	...
	public function test_having()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts HAVING test_posts.test_author_id = 10', $select->compile());	
	}
	...
	public function test_group()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts GROUP BY test_posts.id', $select->compile());	
	}
	...
	public function test_where()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts WHERE test_posts.test_author_id = 10', $select->compile());	
	}
	...
	public function test_order_by()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts ORDER BY test_posts.test_author_id DESC', $select->compile());	
	}
	...
	public function test_aggregate_query($function, $column, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $query->compile());	
	}
	...
	public function test_nested_join()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts JOIN test_authors ON (test_authors.id = test_posts.test_author_id) JOIN test_categories ON (test_categories.test_author_id = test_authors.id)', $select->compile());	
	}
	...
	public function test_manytomany_join()
	{
		...
		$this->assertEquals('SELECT test_posts.* FROM test_posts JOIN test_categories_test_posts ON (test_categories_test_posts.test_post_id = test_posts.id) JOIN test_categories ON (test_categories.id = test_categories_test_posts.test_category_id)', $select->compile());	
	}
