...
class Jam_Association_HasoneTest extends Unittest_TestCase {
	...
	public function test_query_builder($options, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->query_builder('select', $author)->compile());
	}
	...
	public function test_update_builder($options, $id, $model, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->update_query($author, $id, $model)->compile());
	}
