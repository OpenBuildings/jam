 ...
 */
class Jam_Association_HasmanyTest extends Unittest_TestCase {
	...
	public function test_get($name, $options, $value, $expected_ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $result->compile());
	...
	public function test_erase_query($name, $options, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->erase_query($model)->compile());
	}
	...
	public function test_nullify_query($name, $options, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->nullify_query($model)->compile());
	}
	...
	public function test_remove_items_query($name, $options, $ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->remove_items_query($model, $ids)->compile());
	}
	...
	public function test_add_items_query($name, $options, $ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->add_items_query($model, $ids)->compile());
	}
