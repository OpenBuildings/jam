...
class Jam_Association_ManytomanyTest extends Unittest_Jam_TestCase {
	...
	public function test_join($name, $options, $alias, $type, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->join($alias, $type)->compile(Unittest_Jam_Database_TestCase::$database_connection));
	}
	...
	public function test_get($name, $options, $value, $expected_ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $result->compile(Unittest_Jam_Database_TestCase::$database_connection));
	...
	public function test_erase_query($name, $options, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->erase_query($model)->compile(Unittest_Jam_Database_TestCase::$database_connection));
	}
	...
	public function test_remove_items_query($name, $options, $ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->remove_items_query($model, $ids)->compile(Unittest_Jam_Database_TestCase::$database_connection));
	}
	...
	public function test_add_items_query($name, $options, $ids, $expected_sql)
	{
		...
		$this->assertEquals($expected_sql, $association->add_items_query($model, $ids)->compile(Unittest_Jam_Database_TestCase::$database_connection));
	}
